...
function run_single_test {
  ...
  echo -e "\nREMINDER: the most important goal is to minimise the duration of inconsistent forwarding; subordinate to that, you should aim to minimise the number of FIB writes and control-plane packets.\n"
}
...
test_ids="A0 A1 A2 A3 A4 B0 B1 B2 B3 B4 B5 B6 B7 B8 B9 C0 C1 C2"
